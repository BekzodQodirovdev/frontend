        ...
        <div className="flex items-center grow  gap-[46px]">
            ...
            <div className="flex gap-[4px] grow items-center">
                <div className="relative">
                    ...
                    <select
                        className="outline-none border border-[#e1e1e1] py-[9px] pl-[60px] pr-[50px] text-left rounded-bl-[14px] rounded-tl-[14px] appearance-none cursor-pointer text-primary"
                        name="category"
                    >
                ...
                <div className="border relative rounded-r-[14px] w-full py-[9px] pl-[29px] border-[#e1e1e1]">
                    <input
                        ...
                        className="outline-none w-full pr-[75px]"
                    />
