...
import { newArrivals, topSelling } from "../home/data/data";
                ...
                <div className="flex">
                    ...
                    <div className="">
                        ...
                        <p className="max-w-[590px] font-normal pt-[20px] pb-[24px]">
                            ...
                            occasion. Crafted from a soft and breathable fabric,
                            it offers superior comfort and style.
                        </p>
                        <div className="w-full h-[1px] bg-[#e6e6e6]"></div>
                        <p className="pt-[24px] text-[#666666]">
                            Select Colors
                        </p>
                        ...
                        <div className="flex justify-between pt-[24px]">
                            ...
                            <button
                                onClick={addToCard}
                                className="py-[15px] px-[157px] text-[#fff] bg-[#000] rounded-[62px] cursor-pointer"
                            >
                                Add to Cart
                            </button>
                        </div>
